...
from chatbot.forms.chat import ApiKeyForm, SendMessageForm
from chatbot.models import Conversation, Message
from chatbot.services.chat import (
...
class ChatbotServicesTests(TestCase):
    ...
    @patch('chatbot.services.chat.EnhancedChatbotService.generate_response')
