...
urlpatterns = [
    ...
    # Areas (comun)
    path('areas/', login_required(views.AreaConfigListView.as_view()), name='areas'),
    path('areas/crear/', login_required(views.AreaConfigCreateView.as_view()), name='areas_crear'),
    path('areas/<int:pk>/', login_required(views.AreaConfigDetailView.as_view()), name='areas_detalle'),
    path('areas/<int:pk>/editar/', login_required(views.AreaConfigUpdateView.as_view()), name='areas_editar'),
    path('areas/<int:pk>/eliminar/', login_required(views.AreaConfigDeleteView.as_view()), name='areas_eliminar'),
    path('subareas/', login_required(views.SubareaConfigListView.as_view()), name='subareas'),
    path('subareas/crear/', login_required(views.SubareaConfigCreateView.as_view()), name='subareas_crear'),
    path('subareas/<int:pk>/', login_required(views.SubareaConfigDetailView.as_view()), name='subareas_detalle'),
    path('subareas/<int:pk>/editar/', login_required(views.SubareaConfigUpdateView.as_view()), name='subareas_editar'),
    path('subareas/<int:pk>/eliminar/', login_required(views.SubareaConfigDeleteView.as_view()), name='subareas_eliminar'),

    # Reclamos (configuracion)
    path('reclamos/', login_required(views.ReclamoTipoConfiguracionListView.as_view()), name='reclamos'),
    path('reclamos/configuracion/', login_required(views.ReclamoTipoConfiguracionListView.as_view()), name='reclamos_configuracion'),
    path('reclamos/configuracion/agregar/', login_required(views.ReclamoTipoConfiguracionCreateView.as_view()), name='reclamos_configuracion_crear'),
    path('reclamos/configuracion/<int:pk>/', login_required(views.ReclamoTipoConfiguracionDetailView.as_view()), name='reclamos_configuracion_detalle'),
    path('reclamos/configuracion/<int:pk>/editar/', login_required(views.ReclamoTipoConfiguracionUpdateView.as_view()), name='reclamos_configuracion_editar'),
    path('reclamos/catalogos/', login_required(views.ReclamoCatalogosConfigView.as_view()), name='reclamos_catalogos'),
    # Reclamos (operacion)
    ...
    path('reclamos/configuracion/estados/<int:pk>/', login_required(views.EstadoReclamoDetailView.as_view()), name='reclamos_estados_detalle'),
    ...
    path('reclamos/configuracion/prioridades/<int:pk>/', login_required(views.PrioridadReclamoDetailView.as_view()), name='reclamos_prioridades_detalle'),
    ...
    path('tramites/', login_required(views.TramiteTipoConfiguracionListView.as_view()), name='tramites'),
    path('tramites/configuracion/', login_required(views.TramiteTipoConfiguracionListView.as_view()), name='tramites_configuracion'),
    path('tramites/configuracion/agregar/', login_required(views.TramiteTipoConfiguracionCreateView.as_view()), name='tramites_configuracion_crear'),
    path('tramites/configuracion/<int:pk>/', login_required(views.TramiteTipoConfiguracionDetailView.as_view()), name='tramites_configuracion_detalle'),
    path('tramites/configuracion/<int:pk>/editar/', login_required(views.TramiteTipoConfiguracionUpdateView.as_view()), name='tramites_configuracion_editar'),
    path('tramites/catalogos/', login_required(views.TramiteCatalogosConfigView.as_view()), name='tramites_catalogos'),
    # Tramites (operacion)
    ...
    path('tramites/configuracion/tipos/', login_required(views.TramiteTipoConfiguracionListView.as_view()), name='tramites_tipos'),
    path('tramites/configuracion/tipos/crear/', login_required(views.TramiteTipoConfiguracionCreateView.as_view()), name='tramites_tipos_crear'),
    path('tramites/configuracion/tipos/<int:pk>/editar/', login_required(views.TramiteTipoConfiguracionUpdateView.as_view()), name='tramites_tipos_editar'),
    ...
    path('tramites/configuracion/estados/<int:pk>/', login_required(views.EstadoTramiteDetailView.as_view()), name='tramites_estados_detalle'),
    ...
    path('tramites/configuracion/prioridades/<int:pk>/', login_required(views.PrioridadTramiteDetailView.as_view()), name='tramites_prioridades_detalle'),
