...
| US-007 | Como usuario con rol `programaConfigurar` quiero un editor visual de flujos para diseñar el flujo de un programa mediante drag & drop | Grande 🟡 | Stack definido: React Flow + Vite. Requiere US-006. Ver `docs/requerimientos/2026-03-12_editor-visual-flujos.md`. |
...
| US-013 | Como operador quiero poder buscar un ciudadano por nombre o DNI de forma rápida para atender consultas telefónicas sin demoras | Pequeño 🟡 | Ver `docs/requerimientos/2026-03-12_busqueda-rapida-ciudadano.md` |
...
| US-017 | Como operador quiero dar de baja a un ciudadano de un programa persistente registrando motivo y fecha para cerrar su caso formalmente | Pequeño 🟡 | Ver `docs/requerimientos/2026-03-12_baja-ciudadano-programa.md`. Requiere US-006 + US-012. |
| US-018 | Como administrador quiero que las vistas de instituciones estén protegidas por los roles `institucionVer` e `institucionAdministrar` para controlar el acceso al módulo | Pequeño 🟡 | Ver `docs/requerimientos/2026-03-12_permisos-instituciones.md`. Ejecutar junto con US-011. |
...
| US-020 | Como administrador quiero configurar el tipo de acceso de una actividad (libre o requiere programa) para controlar quién puede inscribirse | Pequeño 🟡 | Ver `docs/requerimientos/2026-03-12_tipo-acceso-actividades.md`. Prerequisito de US-022. |
...
| US-021 | Como desarrollador quiero unificar los dos modelos de derivación en uno solo que salga desde Ciudadano para eliminar la duplicación de lógica | Grande 🟡 | Ver `docs/requerimientos/2026-03-12_unificacion-modelos-derivacion.md`. Diseño técnico aprobado. Ejecutar antes de US-006. |
| US-022 | Como operador quiero inscribir ciudadanos a actividades con validación de tipo de acceso, cupo y código de inscripción para gestionar el ingreso a cada actividad institucional | Mediano 🟡 | Requiere US-020. Incluye inscripción desde portal (LIBRE) y desde backoffice. Ver `docs/requerimientos/2026-03-12_actividades-flujo-completo.md` |
