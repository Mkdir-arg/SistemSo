...
from legajos.models_nachec import CasoNachec, HistorialEstadoCaso, RelevamientoNachec, TareaNachec
...
def _confirmar_evaluacion(request, caso, relevamiento, tarea_evaluacion):
    ...
    from legajos.models_nachec import EvaluacionVulnerabilidad, PlanIntervencionNachec
...
def activar_plan(request, caso_id):
    ...
    from legajos.models_nachec import PlanIntervencionNachec, PrestacionNachec
