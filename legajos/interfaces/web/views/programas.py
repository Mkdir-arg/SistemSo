...
class ProgramaDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if programa.tipo in ['NACHEC', 'ÑACHEC']:
            from legajos.models_nachec import CasoNachec
            from legajos.models_programas import DerivacionPrograma
            ...
            from legajos.models_nachec import TareaNachec
            ...
            from legajos.models_nachec import PrestacionNachec, PlanIntervencionNachec, EvaluacionVulnerabilidad, RelevamientoNachec
            ...
            from legajos.models_nachec import PrestacionNachec
...
def dar_de_baja_inscripcion(request, inscripcion_id):
    ...
    """
    from legajos.infrastructure.services.programas import BajaProgramaService
